  ...
  <>
    ...
    <Carousel autoPlay>
      ...
      <div>
        ...
        <p className="legend" id="format">
          <b>List of modules across all universities</b>
        </p>
      </div>
      <div>
        <img className="carousel__img" alt="" src={index3Img} />
        <p className="legend" id="format">
          <b>List of Across Universities</b>
        </p>
      </div>
      <div>
      ...
      <div>
        ...
        <p className="legend" id="format">
          <b>Here you can find comparable modules against your respective module from another university</b>
        </p>
      </div>
      <div>
        <img className="carousel__img" alt="" src={index7Img} />
        <p className="legend" id="format">
          <b>Transfer Credits Declaration Page</b>
        </p>
      </div>
      <div>
        <img className="carousel__img" alt="" src={index8Img} />
        <p className="legend" id="format">
          <b>Choose your university where you want to transfer your credits</b>
        </p>
      </div>
      <div>
        <img className="carousel__img" alt="" src={index9Img} />
        <p className="legend" id="format">
          <b>Select from which completed modules you want to ask for transfer credits</b>
        </p>
      </div>
      <div>
        <img className="carousel__img" alt="" src={index10Img} />
        <p className="legend" id="format">
          <b>Upload your transcript and get verified</b>
        </p>
      </div>
      <div>
        <img className="carousel__img" alt="" src={index11Img} />
        <p className="legend" id="format">
          <b>See your transfer credit modules option in another university</b>
        </p>
      </div>
      <div>
        <img className="carousel__img" alt="" src={index12Img} />
        <p className="legend" id="format">
          <b>Upload your signature</b>
        </p>
      </div>
      <div>
        <img className="carousel__img" alt="" src={index13Img} />
        <p className="legend" id="format">
          <b>Now, you're done with transfer credits process, wait for one week to get confirmation from university</b>
        </p>
      </div>
      <div>
        <img className="carousel__img" alt="" src={index19Img} />
        <p className="legend" id="format">
          <b>User will get notified through email and notification section on their homepage</b>
        </p>
      </div>
      <div>
      ...
      <div>
        ...
        <p className="legend" id="format">
          <b>Admin Panel - User Management</b>
        </p>
      </div>
      <div>
        <img className="carousel__img" alt="" src={index16Img} />
        <p className="legend" id="format">
          <b>Admin Panel - Similarity Table for which you have uploaded the pdf</b>
        </p>
      </div>
      <div>
        <img className="carousel__img" alt="" src={index17Img} />
        <p className="legend" id="format">
          <b>Admin Panel - One-Click PDF Upload</b>
        </p>
      </div>
      <div>
